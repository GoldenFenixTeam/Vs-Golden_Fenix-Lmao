...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
		    ['VS GoldenFenix Team'],
			['GoldenFenix',		'golden',		'Main Programmer and Music Maker of VS GoldenFenix',					'https://twitch.tv/golden_fenixteam',	'0xFF3E557A'],
			['ThatOneEpicGamer',			'thatoneepicgamer',		'Main Cutscene Animator of VS GoldenFenix',				'https://twitter.com/Istoleyourkidn1',		'0xFF3E557A'],
			['IdkSchlatt',			'idkschlatt',		'Main Background Artist of VS GoldenFenix',				'https://twitter.com/IdkSchlatt',		'0xFF3E557A'],
			['BLUE2038',			'blue2038',		'Main Sprite Artist of VS GoldenFenix',				'https://www.youtube.com/channel/UC0FgfCsbygQCYNfPu5_DZbQ',		'0xFF3E557A'],
			[''],
			['Psych Engine Team'],
