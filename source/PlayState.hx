...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['ZAMN! You SUCK!', 0.2], //From 0% to 19%
		['WOOPER', 0.4], //From 20% to 39%
		['ASS', 0.5], //From 40% to 49%
		['Even more trash', 0.6], //From 50% to 59%
		['Kinda Trash Bro', 0.69], //From 60% to 68%
		['Nice Cock!', 0.7], //69%
		['Yo Mama!', 0.8], //From 70% to 79%
		['Deez Nuts', 0.9], //From 80% to 89%
		['Gold!', 1], //From 90% to 99%
		['POGCHAMP!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'stageGolden': //Week 7
				var bg:BGSprite = new BGSprite('stageGolden', -750, -425, 0.9, 0.9);
				add(bg);
		}
